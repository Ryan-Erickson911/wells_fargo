...
class _CategoryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final buttonText = switch (category) {
      PlaceCategory.neutral => 'Stable Investment',
      PlaceCategory.more => 'Invest more!',
      PlaceCategory.less => 'Pending Changes'
    };
...
class _ListCategoryButtonBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        _CategoryButton(
          category: PlaceCategory.neutral,
          selected: selectedCategory == PlaceCategory.neutral,
          onCategoryChanged: onCategoryChanged,
        ),
        _CategoryButton(
          category: PlaceCategory.more,
          selected: selectedCategory == PlaceCategory.more,
          onCategoryChanged: onCategoryChanged,
        ),
        _CategoryButton(
          category: PlaceCategory.less,
          selected: selectedCategory == PlaceCategory.less,
          onCategoryChanged: onCategoryChanged,
        ),
      ],
    );
